...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 3 · 🔀 21 · 📥 300 · 📦 75 · 📋 43 - 11% open · ⏱️ 11.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 10K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 46 · 📦 6 · ⏱️ 12.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 14K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap) (📥 24K / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 520 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 610 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ivory) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 87 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 820 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 830K / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 13 · 🔀 13 · 📥 21K · 📦 500 · 📋 46 - 45% open · ⏱️ 23.11.2025)
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 34 · 📦 69 · 📋 73 - 31% open · ⏱️ 29.08.2025)
- [PyPi](https://pypi.org/project/mkdoxy) (📥 57K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 34K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 35 · ⏱️ 23.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 75 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 29 · 📥 440 · 📋 62 - 22% open · ⏱️ 02.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-rss-plugin) (📥 200K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blogging-plugin) (📥 13K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 5.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 750K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 79K / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 45 · 📦 60 · 📋 33 - 18% open · ⏱️ 22.12.2025)
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 17 · 🔀 33 · 📦 3.7K · 📋 88 - 17% open · ⏱️ 14.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 44K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/lightgallery) (📥 4.1K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 96 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-matplotlib) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/six-two/mkdocs-badges) (👨‍💻 2 · 🔀 3 · 📋 9 - 11% open · ⏱️ 29.01.2026)
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 72 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 98 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 240 / month):
	```
...
- [GitHub](https://github.com/fralau/mkdocs-macros-plugin) (👨‍💻 36 · 🔀 50 · 📦 6.8K · 📋 150 - 2% open · ⏱️ 03.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 540K / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 15 · 📦 800 · 📋 67 - 22% open · ⏱️ 10.02.2026)
...
- [PyPi](https://pypi.org/project/mknotebooks) (📥 37K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 580K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 4.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 280K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 25K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 60K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 100 · ⏱️ 14.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 31K / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-extra-sass-plugin) (🔀 4 · 📦 89 · ⏱️ 13.02.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 160 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 68 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 12 · 📦 440 · ⏱️ 01.12.2025)
...
- [GitHub](https://github.com/blueswen/mkdocs-swagger-ui-tag) (👨‍💻 8 · 🔀 14 · 📥 47 · 📦 410 · 📋 32 - 31% open · ⏱️ 22.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 85K / month):
	```
...
- [GitHub](https://github.com/leonardocustodio/mkdocs-copy-to-llm) (👨‍💻 4 · 🔀 2 · 📦 4 · 📋 9 - 22% open · ⏱️ 10.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 92 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 86 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 380K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-translations) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 130K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 580K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 7.1K / month):
	```
...
- [PyPi](https://pypi.org/project/autolink-references-mkdocs-plugin) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 97 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-backlinks-section-plugin) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 480 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 56 · 🔀 270 · 📦 58K · 📋 430 - 3% open · ⏱️ 13.05.2026)
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 2.3M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-checklist) (📥 4.2K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 570 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 32K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 1.6M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 160 / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 920 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 56 / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 260 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 4.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 59 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 270K / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 280 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 68 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 65 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 72K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 35K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 3.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 24 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 61K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 870 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 76 / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 50 · 🔀 78 · 📦 210 · ⏱️ 14.05.2026)
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 9 · 📦 63 · ⏱️ 13.05.2026)
...
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 49K · ⏱️ 01.05.2026):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 4.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 650K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-descriptions-plugin) (📥 23K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 65K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-embed-external-markdown) (📥 9.7K / month):
	```
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 26 · 📦 96 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 560 / month):
	```
