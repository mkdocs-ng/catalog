...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 87K · 📋 2.7K - 0% open · ⏱️ 13.05.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 4 · 🔀 21 · 📥 310 · 📦 77 · 📋 46 - 13% open · ⏱️ 20.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 6.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 7.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootswatch) (📥 22K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 9.7K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 46 · 📦 6 · ⏱️ 25.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 8.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 440 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [GitHub](https://github.com/TEParsons/torillic) (👨‍💻 4 · 🔀 83 · 📥 7.9K · 📋 13 - 15% open · ⏱️ 21.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ivory) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 85 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cluster) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 7.1M / month):
	```
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 34 · 📦 71 · 📋 74 - 32% open · ⏱️ 29.08.2025)
- [PyPi](https://pypi.org/project/mkdoxy) (📥 55K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkapi) (📥 11K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 59 · 📦 250 · 📋 17 - 17% open · ⏱️ 09.01.2026)
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 32K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 38 · ⏱️ 27.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-typer) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 17K / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/shell) (📦 73 · 📋 5 - 20% open · ⏱️ 19.09.2025)
</details>
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 330 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 760 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 85 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 34 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 84K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 690K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-build-plantuml-plugin) (📥 30K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 78K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 85 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/docutools) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 65 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 92 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 660 / month):
	```
...
- [GitHub](https://github.com/fralau/mkdocs-macros-plugin) (👨‍💻 36 · 🔀 51 · 📦 6.9K · 📋 150 - 2% open · ⏱️ 03.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 570K / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 15 · 📦 810 · 📋 68 - 23% open · ⏱️ 10.02.2026)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 930K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdownextradata-plugin) (📥 130K / month):
	```
...
- [GitHub](https://github.com/six-two/mkdocs-placeholder-plugin) (👨‍💻 3 · 🔀 4 · 📦 20 · ⏱️ 25.05.2026)
...
- [PyPi](https://pypi.org/project/termynal) (📥 34K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyterlite) (📥 2.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 4 · 🔀 5 · 📦 44 · ⏱️ 27.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 120K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 49K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 100 · ⏱️ 28.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 8.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 12K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 88 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 12 · 📦 460 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 300K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swagger-ui-tag) (📥 240K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 430K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mdpo-plugin) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 77K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 6.9M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 45K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 19K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 19K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 230 / month):
	```
...
<details><summary><b><a href="https://github.com/rhshadrach/mkdocs-argref-plugin">ArgRef</a></b>  - 🥉7 ·  ⭐ 3 · 💤 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>mkdocs plugin to provides GitHub like autolink references in Mkdocs.</summary>

- [GitHub](https://github.com/rhshadrach/mkdocs-argref-plugin) (👨‍💻 5 · 🔀 1 · ⏱️ 25.08.2024)
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 280 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 56 · 🔀 270 · 📦 59K · 📋 430 - 3% open · ⏱️ 26.05.2026)
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 410K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-callouts) (📥 62K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 140K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 2.1M / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 740K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 230 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 480 / month):
	```
...
<details><summary><b><a href="https://github.com/aleray/mdx_cite">Cite Extension</a></b>  - 🥉4 ·  ⭐ 7 · 💤 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1459/PNG/32/2799201-jigsaw-processing_99781.png" style="display:inline;" width="13" height="13"></code><br>Python-Markdown extension to support the cite tag.</summary>

- [GitHub](https://github.com/aleray/mdx_cite) (🔀 3 · ⏱️ 21.04.2012)
- [PyPi](https://pypi.org/project/mdx-cite) (📥 52 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 290K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 140K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 5.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-file-filter-plugin) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 130 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-include-dir-to-nav) (📥 61K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 69 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 74 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 940 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 81 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 83 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 77K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 2.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 52K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 200K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 22K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 690 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 910 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 750 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 49 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 71 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 99 / month):
	```
...
<details><summary><b><a href="https://github.com/jimporter/mike">mike</a></b>  - 🥇30 ·  ⭐ 740 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Manage multiple versions of your MkDocs-powered documentation via Git.</summary>

- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 52 · 📥 490 · 📦 6.4K · 📋 200 - 6% open · ⏱️ 14.04.2026)
- [PyPi](https://pypi.org/project/mike) (📥 1.4M / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo-plugin) (📥 63K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 12K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 950 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 65 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 18 · 🔀 26 · 📥 710 · 📦 3.9K · 📋 100 - 0% open · ⏱️ 15.05.2026)
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 26 · 📦 98 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 540 / month):
	```
