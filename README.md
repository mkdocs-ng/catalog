...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 89K · 📋 2.7K - 0% open · ⏱️ 06.07.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 5 · 🔀 22 · 📥 340 · 📦 88 · 📋 49 - 10% open · ⏱️ 19.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootswatch) (📥 20K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 65 · 📦 6 · ⏱️ 09.07.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 5.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 950 / month):
	```
...
<details><summary><b><a href="https://github.com/wsoft-ws/lantana">Lantana</a></b>  - 🥈12 ·  ⭐ 26 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Lantana MKDocsHTML.</summary>
...
- [PyPi](https://pypi.org/project/lantana) (📥 130 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 790 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 31K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 930 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 75 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 55 · 🔀 120 · 📦 29K · 📋 480 - 1% open · ⏱️ 08.07.2026)
...
- [GitHub](https://github.com/mkdocstrings/python) (👨‍💻 29 · 🔀 51 · 📋 210 - 3% open · ⏱️ 08.07.2026)
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 77 · 📦 280 · 📋 17 - 17% open · ⏱️ 04.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-typer) (📥 17K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 60 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 57 / month):
	```
...
- [GitHub](https://github.com/mkdocs-publisher/mkdocs-publisher) (👨‍💻 4 · 🔀 13 · 📥 140 · 📦 100 · 📋 31 - 25% open · ⏱️ 26.11.2025)
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 4.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 980 / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 63 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 880K / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 71 · 📦 69 · 📋 34 - 17% open · ⏱️ 22.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 46K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 540 / month):
	```
...
- [PyPi](https://pypi.org/project/lightgallery) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 68K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 75 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 850 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-matplotlib) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 20K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 160 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 93 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 330 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 230 / month):
	```
...
- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 39 · 🔀 63 · 📦 5.2K · 📋 160 - 29% open · ⏱️ 17.04.2026)
...
<details><summary><b><a href="https://github.com/pawamoy/markdown-exec">markdown-exec</a></b>  - 🥇25 ·  ⭐ 170 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Utilities to execute code blocks in Markdown files.</summary>

- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 17 · 📦 850 · 📋 69 - 23% open · ⏱️ 08.07.2026)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 770K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 900K / month):
	```
...
- [PyPi](https://pypi.org/project/termynal) (📥 59K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 75 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 4 · 🔀 5 · 📦 61 · ⏱️ 30.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-minify-plugin) (📥 970K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 2 · 📦 100 · ⏱️ 09.07.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 59K / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-extra-sass-plugin) (🔀 4 · 📦 92 · ⏱️ 13.02.2021)
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 8.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 330 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap-tables-plugin) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 54 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 13 · 📦 560 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 370K / month):
	```
...
- [GitHub](https://github.com/blueswen/mkdocs-swagger-ui-tag) (👨‍💻 8 · 🔀 16 · 📥 50 · 📦 440 · 📋 34 - 35% open · ⏱️ 22.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 59 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 590K / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 16 · 🔀 18 · 📦 730 · 📋 39 - 10% open · ⏱️ 23.02.2026)
...
- [GitHub](https://github.com/JakubAndrysek/mkdocs-open-in-new-tab) (👨‍💻 2 · 🔀 5 · 📦 710 · 📋 9 - 44% open · ⏱️ 18.11.2024)
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 200K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 58K / month):
	```
...
- [GitHub](https://github.com/timmeinerzhagen/mkdocs-link-marker) (👨‍💻 3 · 🔀 2 · 📦 51 · 📋 5 - 40% open · ⏱️ 04.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 900K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-roamlinks-plugin) (📥 29K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 6.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 68 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 700 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 96 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 81K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 920 / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 99 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 35K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 50K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 140 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 12 · 🔀 42 · 📦 640 · 📋 120 - 18% open · ⏱️ 10.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 390K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-encryptcontent-plugin) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-literate-nav) (📥 1.8M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-file-filter-plugin) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 75 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 62 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 96 / month):
	```
...
<details><summary><b><a href="https://github.com/koaning/mktestdocs">mktestdocs</a></b>  - 🥈10 ·  ⭐ 160 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code><br>Run pytest against markdown files/docstrings.</summary>

- [GitHub](https://github.com/koaning/mktestdocs) (👨‍💻 6 · 🔀 11 · 📋 8 - 37% open · ⏱️ 10.11.2025)
- [PyPi](https://pypi.org/project/mktestdocs):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 5.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 46K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 540 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 79 / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 51 · 🔀 80 · 📦 220 · 📋 83 - 1% open · ⏱️ 03.07.2026)
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 760K / month):
	```
...
- [GitHub](https://github.com/jdoiro3/mkdocs-multirepo-plugin) (👨‍💻 17 · 🔀 60 · 📦 260 · 📋 120 - 52% open · ⏱️ 19.03.2026)
...
<details><summary><b><a href="https://github.com/wilhelmer/mkdocs-multirepo">multirepo</a></b>  - 🥉13 ·  ⭐ 47 · 💤 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code><br>A bit like monorepo, but keeps MkDocs projects separate.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 14K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yamp) (📥 87 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 600K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-include) (📥 270K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 47K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-embed-external-markdown) (📥 8.9K / month):
	```
