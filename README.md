...
- [📊 Charts, Images, Tables & Graphs](#-charts-images-tables--graphs) _5 projects_
...
- [🔗 Links & references](#-links--references) _3 projects_
...
- [🔧 Site building, site management](#-site-building-site-management) _1 projects_
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-drawio-exporter) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-img2fig-plugin) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 13K / month):
	```
...
<details><summary><b><a href="https://aiboy996.github.io/mkdocs-ai-summary/">mkdocs-ai-summary</a></b>  - 🥉4 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code></summary>

- [GitHub]() (📦 4)
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 43 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-translations) (📥 60 / month):
	```
...
- [GitHub](https://github.com/shyamd/mkdocs-bibtex) (👨‍💻 21 · 🔀 31 · 📋 59 - 10% open · ⏱️ 01.11.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 17K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 53K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 23 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 7.9K / month):
	```
