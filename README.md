...
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 66 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 100 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 820K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 3.5K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 90 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 550K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 710K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 830 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 310K / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 300 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 6.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 770 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 61 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 36 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 8.3K / month):
	```
