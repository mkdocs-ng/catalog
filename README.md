...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 89K · 📋 2.7K - 0% open · ⏱️ 20.06.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 5 · 🔀 22 · 📥 330 · 📦 88 · 📋 48 - 8% open · ⏱️ 19.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-bootswatch) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 9.4K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 58 · 📦 6 · ⏱️ 24.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 5.3K / month):
	```
...
<details><summary><b><a href="https://github.com/wsoft-ws/lantana">Lantana</a></b>  - 🥈13 ·  ⭐ 26 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Lantana MKDocsHTML.</summary>
...
- [PyPi](https://pypi.org/project/lantana) (📥 220 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [GitHub](https://github.com/TEParsons/torillic) (👨‍💻 4 · 🔀 82 · 📥 8K · 📋 13 - 15% open · ⏱️ 21.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 860 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 850 / month):
	```
...
<details><summary><b><a href="https://github.com/swan-cern/mkdocs-swan">SWAN</a></b>  - 🥉11 ·  ⭐ 6 · <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>SWAN MkDocs theme.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 30K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 93 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 690 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 85 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/python) (👨‍💻 29 · 🔀 51 · 📋 210 - 3% open · ⏱️ 19.06.2026)
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 13 · 🔀 13 · 📥 23K · 📦 520 · 📋 47 - 44% open · ⏱️ 23.11.2025)
...
<details><summary><b><a href="https://github.com/tlambert03/mkdocs-api-autonav">mkdocs-api-autonav</a></b>  - 🥈17 ·  ⭐ 43 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for autogenerating API docs with navigation.</summary>

- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 64 · 📦 270 · 📋 17 - 17% open · ⏱️ 04.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 23K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (👨‍💻 2 · 🔀 2 · 📦 47 · ⏱️ 17.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 17K / month):
	```
...
<details><summary><b><a href="https://github.com/watermarkhu/mkdocstrings-matlab">mkdocstrings-matlab</a></b>  - 🥉12 ·  ⭐ 16 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code><br>A MATLAB handler for mkdocstrings, automatic documentation from sources.</summary>
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 73 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 69 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 30 · 📥 450 · 📋 62 - 22% open · ⏱️ 02.07.2026)
...
- [GitHub](https://github.com/mkdocs-publisher/mkdocs-publisher) (👨‍💻 4 · 🔀 12 · 📥 140 · 📦 99 · 📋 31 - 25% open · ⏱️ 26.11.2025)
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 3.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 88 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/blueswen/mkdocs-glightbox) (👨‍💻 9 · 🔀 22 · 📥 46 · 📦 6.2K · 📋 58 - 43% open · ⏱️ 08.03.2026)
...
<details><summary><b><a href="https://github.com/MikhailKravets/mkdocs_puml">mkdocs_puml</a></b>  - 🥈19 ·  ⭐ 63 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Inline PlantUML diagrams in your MkDocs documentation.</summary>

- [GitHub](https://github.com/MikhailKravets/mkdocs_puml) (👨‍💻 10 · 🔀 18 · 📦 80 · 📋 34 - 32% open · ⏱️ 03.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 60K / month):
	```
...
- [GitHub](https://github.com/soulless-viewer/mkdocs-video) (👨‍💻 5 · 🔀 14 · 📥 76 · 📦 1.2K · ⏱️ 04.01.2024)
...
<details><summary><b><a href="https://github.com/landmaj/mkdocs-d2-plugin">mkdocs-d2-plugin</a></b>  - 🥈16 ·  ⭐ 38 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A plugin for embedding D2 diagrams in MkDocs.</summary>

- [GitHub](https://github.com/landmaj/mkdocs-d2-plugin) (👨‍💻 4 · 🔀 8 · 📦 36 · 📋 20 - 5% open · ⏱️ 09.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 50K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-blockdiag) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 69K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 99 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 2.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 99 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 50 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 84 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 190 / month):
	```
...
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b>  - 🥇25 ·  ⭐ 500 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Use Jupyter Notebook in mkdocs.</summary>

- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 39 · 🔀 64 · 📦 5.2K · 📋 160 - 29% open · ⏱️ 17.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 520K / month):
	```
...
- [GitHub](https://github.com/oprypin/mkdocs-gen-files) (👨‍💻 6 · 🔀 12 · 📦 4.5K · 📋 30 - 30% open · ⏱️ 17.04.2026)
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 16 · 📦 840 · 📋 68 - 23% open · ⏱️ 10.02.2026)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 840K / month):
	```
...
- [GitHub](https://github.com/marimo-team/mkdocs-marimo) (👨‍💻 8 · 🔀 5 · 📦 13 · 📋 28 - 57% open · ⏱️ 15.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 870K / month):
	```
...
- [PyPi](https://pypi.org/project/termynal) (📥 54K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyterlite) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 99 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 88 / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 43 · 🔀 53 · 📦 13K · 📋 120 - 0% open · ⏱️ 10.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-localized-plugin) (📥 1.6M / month):
	```
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 4 · 🔀 5 · 📦 59 · ⏱️ 30.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 1.3M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 900 / month):
	```
...
<details><summary><b><a href="https://github.com/monosans/mkdocs-minify-html-plugin">minify-html</a></b>  - 🥇21 ·  ⭐ 11 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for minification using minify-html, an extremely fast and smart HTML + JS + CSS minifier.</summary>

- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 2 · 📦 100 · ⏱️ 02.07.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 60K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 5.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 14K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap-tables-plugin) (📥 910 / month):
	```
...
- [GitHub](https://github.com/wilhelmer/mkdocs-add-teaser) (👨‍💻 3 · 🔀 1 · ⏱️ 08.11.2022)
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 59 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 13 · 📦 530 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 350K / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-coverage) (👨‍💻 2 · 🔀 1 · 📦 350 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 82K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 160 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 78 / month):
	```
...
- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 14 · 🔀 49 · 📦 2.5K · 📋 160 - 19% open · ⏱️ 02.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 580K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-translations) (📥 120 / month):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs-redirects) (👨‍💻 18 · 🔀 35 · 📦 7.8K · 📋 42 - 33% open · ⏱️ 19.05.2025)
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 16 · 🔀 18 · 📦 720 · 📋 39 - 10% open · ⏱️ 23.02.2026)
...
- [GitHub](https://github.com/EddyLuten/mkdocs-alias-plugin) (👨‍💻 6 · 🔀 4 · 📦 39 · ⏱️ 18.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 870K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-roamlinks-plugin) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 6.5K / month):
	```
...
<details><summary><b><a href="https://github.com/realtimeprojects/mkdocs-ezglossary">ezglossary</a></b>  - 🥉9 ·  ⭐ 17 · 📉 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Glossary support for mkdocs.</summary>

- [GitHub](https://github.com/realtimeprojects/mkdocs-ezglossary) (👨‍💻 6 · 🔀 1 · 📋 26 - 11% open · ⏱️ 11.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 370K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 1.5M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 83K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 35K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 40K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 52K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 45 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-encryptcontent-plugin) (📥 16K / month):
	```
...
<details><summary><b><a href="https://github.com/lukasgeiter/mkdocs-awesome-nav">awesome-nav</a></b>  - 🥇21 ·  ⭐ 620 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A plugin for customizing the navigation structure of your MkDocs site.</summary>

- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 12 · 🔀 43 · 📦 630 · 📋 120 - 18% open · ⏱️ 10.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 250K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 7.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 43K / month):
	```
...
- [GitHub](https://github.com/tombreit/mkdocs-pagetree-plugin) (👨‍💻 3 · 🔀 3 · 📦 33 · 📋 15 - 13% open · ⏱️ 02.11.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 56 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 88 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 88K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 70 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 47K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 330K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 46 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 110 / month):
	```
...
<details><summary><b><a href="https://github.com/jimporter/mike">mike</a></b>  - 🥇28 ·  ⭐ 740 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Manage multiple versions of your MkDocs-powered documentation via Git.</summary>

- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 52 · 📥 500 · 📦 6.6K · 📋 200 - 6% open · ⏱️ 14.04.2026)
- [PyPi](https://pypi.org/project/mike) (📥 1.7M / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 51 · 🔀 79 · 📦 220 · 📋 83 - 1% open · ⏱️ 26.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 750K / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-monorepo-plugin) (👨‍💻 32 · 🔀 78 · 📦 680 · 📋 76 - 53% open · ⏱️ 15.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-monorepo-plugin) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 9 · 📦 63 · ⏱️ 02.07.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 3K / month):
	```
...
<details><summary><b><a href="https://github.com/leonardehrenfried/mkdocs-no-sitemap-plugin">no-sitemap</a></b>  - 🥉8 ·  ⭐ 3 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Disable Mkdocs sitemap generation.</summary>

- [GitHub](https://github.com/leonardehrenfried/mkdocs-no-sitemap-plugin) (👨‍💻 2 · 🔀 1 · 📦 55 · ⏱️ 23.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 47 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 18 · 🔀 26 · 📥 720 · 📦 4K · 📋 100 - 0% open · ⏱️ 15.05.2026)
...
- [GitHub](https://github.com/rnorth/mkdocs-codeinclude-plugin) (👨‍💻 5 · 🔀 6 · 📦 200 · 📋 12 - 41% open · ⏱️ 20.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-embed-external-markdown) (📥 9.6K / month):
	```
