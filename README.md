...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 4 · 🔀 21 · 📥 310 · 📦 81 · 📋 46 - 13% open · ⏱️ 20.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 31K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 9.5K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 49 · 📦 6 · ⏱️ 03.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 8.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ivory) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 57 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 97 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cluster) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 900K / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 13 · 🔀 13 · 📥 22K · 📦 510 · 📋 46 - 45% open · ⏱️ 23.11.2025)
...
- [PyPi](https://pypi.org/project/mkdoxy) (📥 58K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 60 · 📦 260 · 📋 17 - 17% open · ⏱️ 04.06.2026)
...
- [GitHub](https://github.com/jcayers20/mkdocs-autoapi) (👨‍💻 2 · 🔀 1 · 📥 9 · 📦 130 · 📋 37 - 21% open · ⏱️ 29.01.2026)
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 40 · ⏱️ 27.05.2026)
...
- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 2 · 📥 16 · 📦 2 · 📋 14 - 35% open · ⏱️ 03.06.2026)
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 820 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 47 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 29 · 📥 450 · 📋 62 - 22% open · ⏱️ 03.06.2026)
...
- [GitHub](https://github.com/liang2kl/mkdocs-blogging-plugin) (👨‍💻 7 · 🔀 15 · 📥 24 · 📦 320 · 📋 41 - 12% open · ⏱️ 21.07.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 67 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 800K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 88K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 870K / month):
	```
...
<details><summary><b><a href="https://github.com/PLAYG0N/mkdocs-panzoom">panzoom</a></b>  - 🥈19 ·  ⭐ 66 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Plugin to enable pan & zoom on images and mermaid/d2 diagrams.</summary>

- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 47 · 📦 64 · 📋 34 - 20% open · ⏱️ 22.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 770K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 59K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-video) (📥 200K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-blockdiag) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 79K / month):
	```
...
- [GitHub](https://github.com/attakei/oEmbedPy) (👨‍💻 2 · 🔀 1 · 📥 43 · 📦 17 · 📋 8 - 62% open · ⏱️ 27.12.2025)
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 55 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/docutools) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 930 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-matplotlib) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 91 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 30 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 58 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdownextradata-plugin) (📥 120K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 670K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 13K / month):
	```
...
- [GitHub](https://github.com/rahult/mkdocs-user-defined-values) (👨‍💻 3 · 🔀 3 · 📥 18 · 📦 15 · 📋 2 - 50% open · ⏱️ 10.07.2022)
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 43 · 🔀 54 · 📦 12K · ⏱️ 01.06.2026)
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 4 · 🔀 5 · 📦 49 · 📋 26 - 3% open · ⏱️ 04.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-git-committers-plugin-2) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 510 / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 100 · ⏱️ 04.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 50 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 12 · 📦 470 · ⏱️ 01.12.2025)
...
- [GitHub](https://github.com/blueswen/mkdocs-swagger-ui-tag) (👨‍💻 8 · 🔀 14 · 📥 49 · 📦 420 · 📋 32 - 31% open · ⏱️ 22.02.2026)
- [PyPi](https://pypi.org/project/mkdocs-swagger-ui-tag) (📥 250K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 75K / month):
	```
...
- [PyPi](https://pypi.org/project/foliantcontrib.mkdocs) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 48 / month):
	```
...
- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 14 · 🔀 50 · 📦 2.4K · 📋 160 - 19% open · ⏱️ 02.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 480K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mdpo-plugin) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-translations) (📥 110 / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 16 · 🔀 18 · 📦 710 · 📋 38 - 7% open · ⏱️ 23.02.2026)
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 78K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 140K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezlinks-plugin) (📥 22K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-roamlinks-plugin) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 170 / month):
	```
...
- [GitHub](https://github.com/Darrelk/mkdocs-webcontext-plugin) (👨‍💻 2 · 🔀 1 · 📥 12 · 📦 6 · ⏱️ 23.05.2025)
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 390K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-callouts) (📥 70K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 89K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 42K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 670K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 2.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 91 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 31 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 120 / month):
	```
...
- [GitHub](https://github.com/aklajnert/mkdocs-simple-hooks) (👨‍💻 6 · 🔀 4 · 📥 66 · 📦 2.3K · ⏱️ 14.11.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 80 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 52 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 6.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 37 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 850 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 85K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 29 / month):
	```
...
- [GitHub](https://github.com/chrieke/mkdocs-exclude-search) (👨‍💻 6 · 🔀 3 · 📥 17 · ⏱️ 04.12.2023)
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 62K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 89K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 520 / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 72 · 📦 900 · 📋 120 - 57% open · ⏱️ 14.10.2021)
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 240K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 980 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 28 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 36 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 63 / month):
	```
...
- [PyPi](https://pypi.org/project/mike) (📥 1.5M / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 51 · 🔀 79 · 📦 210 · ⏱️ 19.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 710K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-plugin) (📥 38K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/JonasDoesThings/mkdocs-exclude-unused-files) (👨‍💻 4 · 🔀 2 · 📥 11 · 📦 27 · 📋 4 - 25% open · ⏱️ 11.06.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 460 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-new-features-notifier) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-descriptions-plugin) (📥 17K / month):
	```
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 29 · 📦 98 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 680 / month):
	```
