...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 86K · 📋 2.7K - 0% open · ⏱️ 13.05.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 4 · 🔀 21 · 📥 310 · 📦 76 · 📋 45 - 11% open · ⏱️ 20.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 25K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-blog) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 46 · 📦 6 · ⏱️ 18.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 560 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [GitHub](https://github.com/TEParsons/torillic) (👨‍💻 4 · 🔀 84 · 📥 7.9K · 📋 13 - 15% open · ⏱️ 21.04.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 570 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 330 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ivory) (📥 3.7K / month):
	```
...
<details><summary><b><a href="https://github.com/noraj/mkdocs-windmill-dark">Windmill Dark</a></b>  - 🥉7 ·  ⭐ 38 · 💤 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Outstanding mkdocs theme with a focus on navigation and usability.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cluster) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 810K / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 13 · 🔀 13 · 📥 21K · 📦 510 · 📋 46 - 45% open · ⏱️ 23.11.2025)
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 34 · 📦 70 · 📋 74 - 32% open · ⏱️ 29.08.2025)
- [PyPi](https://pypi.org/project/mkdoxy) (📥 56K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
<details><summary><b><a href="https://github.com/tlambert03/mkdocs-api-autonav">mkdocs-api-autonav</a></b>  - 🥈18 ·  ⭐ 42 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for autogenerating API docs with navigation.</summary>

- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 59 · 📦 240 · 📋 17 - 17% open · ⏱️ 09.01.2026)
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 42K / month):
	```
...
- [GitHub](https://github.com/jcayers20/mkdocs-autoapi) (👨‍💻 2 · 🔀 1 · 📥 8 · 📦 130 · 📋 37 - 21% open · ⏱️ 29.01.2026)
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 33K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 37 · ⏱️ 23.04.2026)
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 22K / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 640 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/shell) (📦 71 · 📋 5 - 20% open · ⏱️ 19.09.2025)
</details>
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 540 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 2.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 96 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 35 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 29 · 📥 450 · 📋 62 - 22% open · ⏱️ 20.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-rss-plugin) (📥 210K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blogging-plugin) (📥 25K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 98 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 760K / month):
	```
...
- [GitHub](https://github.com/blueswen/mkdocs-glightbox) (👨‍💻 9 · 🔀 22 · 📥 44 · 📦 6.1K · 📋 58 - 43% open · ⏱️ 08.03.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 890K / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 46 · 📦 63 · 📋 33 - 18% open · ⏱️ 22.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 670K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 230K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 47K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-blockdiag) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/lightgallery) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/attakei/oEmbedPy) (👨‍💻 2 · 🔀 1 · 📥 42 · 📦 17 · 📋 8 - 62% open · ⏱️ 27.12.2025)
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid-plugin) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 19K / month):
	```
...
- [PyPi](https://pypi.org/project/docutools) (📥 210 / month):
	```
...
<details><summary><b><a href="https://github.com/six-two/mkdocs-badges">badges</a></b>  - 🥉9 ·  ⭐ 18 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Add badges to your mkdocs page.</summary>

- [GitHub](https://github.com/six-two/mkdocs-badges) (👨‍💻 2 · 🔀 3 · ⏱️ 19.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-matplotlib) (📥 2.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 4.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 75 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 560K / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 15 · 📦 800 · 📋 68 - 23% open · ⏱️ 10.02.2026)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 940K / month):
	```
...
- [PyPi](https://pypi.org/project/mknotebooks) (📥 38K / month):
	```
...
- [GitHub](https://github.com/marimo-team/mkdocs-marimo) (👨‍💻 7 · 🔀 6 · 📦 11 · 📋 27 - 55% open · ⏱️ 13.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-marimo) (📥 17K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-placeholder-plugin) (📥 14K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 570K / month):
	```
...
- [PyPi](https://pypi.org/project/termynal) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 42 · 🔀 53 · 📦 12K · ⏱️ 13.05.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 460 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 630 / month):
	```
...
<details><summary><b><a href="https://github.com/monosans/mkdocs-minify-html-plugin">minify-html</a></b>  - 🥇20 ·  ⭐ 13 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for minification using minify-html, an extremely fast and smart HTML + JS + CSS minifier.</summary>

- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 100 · ⏱️ 20.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 34K / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-extra-sass-plugin) (🔀 4 · 📦 90 · ⏱️ 13.02.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 930 / month):
	```
...
- [GitHub](https://github.com/six-two/mkdocs-toggle-sidebar-plugin) (👨‍💻 2 · 🔀 3 · 📋 10 - 10% open · ⏱️ 20.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 95 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 12 · 📦 450 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 310K / month):
	```
...
- [GitHub](https://github.com/blueswen/mkdocs-swagger-ui-tag) (👨‍💻 8 · 🔀 14 · 📥 47 · 📦 420 · 📋 32 - 31% open · ⏱️ 22.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 83K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-render-swagger-plugin) (📥 110K / month):
	```
...
- [PyPi](https://pypi.org/project/foliantcontrib.mkdocs) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 91 / month):
	```
...
<details><summary><b><a href="https://github.com/ultrabug/mkdocs-static-i18n">static-i18n</a></b>  - 🥇22 ·  ⭐ 320 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs i18n plugin using static translation markdown files.</summary>

- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 14 · 🔀 49 · 📦 2.4K · 📋 160 - 19% open · ⏱️ 02.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 390K / month):
	```
...
<details><summary><b><a href="https://pypi.org/project/mkdocs-translations/">Mkdocs translations plugin</a></b>  - 🥉3 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Internationalization plugin for mkdocs.</summary>
...
- [GitHub](https://github.com/mkdocs/mkdocs-redirects) (👨‍💻 18 · 🔀 35 · 📦 7.6K · 📋 42 - 33% open · ⏱️ 19.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-redirects) (📥 1.5M / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 16 · 🔀 18 · 📦 700 · 📋 38 - 7% open · ⏱️ 23.02.2026)
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 81K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 150K / month):
	```
...
- [GitHub](https://github.com/JakubAndrysek/mkdocs-open-in-new-tab) (👨‍💻 2 · 🔀 5 · 📦 690 · 📋 9 - 44% open · ⏱️ 18.11.2024)
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 570K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 49K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 3.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezlinks-plugin) (📥 23K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-roamlinks-plugin) (📥 24K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/autolink-references-mkdocs-plugin) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 230 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 56 · 🔀 270 · 📦 59K · 📋 430 - 3% open · ⏱️ 18.05.2026)
...
- [GitHub](https://github.com/oprypin/markdown-callouts) (👨‍💻 2 · 🔀 14 · 📦 690 · 📋 13 - 38% open · ⏱️ 17.04.2026)
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 150K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 85K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 580 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 37K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 1.5M / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/flywire/caption) (👨‍💻 4 · 🔀 3 · 📦 70 · 📋 8 - 87% open · ⏱️ 03.05.2025)
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
   ```yaml
   markdown_extensions:
     - caption
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 83 / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 220 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [GitHub](https://github.com/pawamoy/markdown-pycon) (📦 10 · ⏱️ 10.01.2025)
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
   ```yaml
   markdown_extensions:
     - pycon
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 4K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 63 / month):
	```
...
<details><summary><b><a href="https://pypi.org/project/markdown-djangostaticimage/">Django Static Image</a></b>  - 🥉2 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1459/PNG/32/2799201-jigsaw-processing_99781.png" style="display:inline;" width="13" height="13"></code></summary>

- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 160 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 12 · 🔀 43 · 📦 590 · 📋 120 - 18% open · ⏱️ 10.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 280K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 150K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 47K / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 170 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 75K / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 45K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 2.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-localsearch) (📥 5.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 290 / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 73 · 📦 900 · 📋 120 - 57% open · ⏱️ 14.10.2021)
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 150K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-export-plugin) (📥 40K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 20K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 970 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 810 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 54 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 82 / month):
	```
...
- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 52 · 📥 480 · 📦 6.3K · 📋 200 - 6% open · ⏱️ 14.04.2026)
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 51 · 🔀 78 · 📦 210 · ⏱️ 19.05.2026)
...
<details><summary><b><a href="https://github.com/backstage/mkdocs-monorepo-plugin">monorepo</a></b>  - 🥇24 ·  ⭐ 400 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Build multiple documentation folders in a single Mkdocs. Designed for large codebases.</summary>

- [GitHub](https://github.com/backstage/mkdocs-monorepo-plugin) (👨‍💻 32 · 🔀 77 · 📦 670 · 📋 76 - 53% open · ⏱️ 15.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-monorepo-plugin) (📥 1.4M / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 9 · 📦 63 · ⏱️ 21.05.2026)
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 6 · 🔀 6 · 📦 110 · ⏱️ 18.05.2026)
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 49K · ⏱️ 18.05.2026):
	```
...
<details><summary><b><a href="https://github.com/wilhelmer/mkdocs-multirepo">multirepo</a></b>  - 🥉12 ·  ⭐ 46 · 💤 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code><br>A bit like monorepo, but keeps MkDocs projects separate.</summary>

- [GitHub](https://github.com/wilhelmer/mkdocs-multirepo) (👨‍💻 3 · 🔀 2 · 📦 3 · ⏱️ 04.01.2024)
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 210 / month):
	```
...
- [GitHub](https://github.com/leonardehrenfried/mkdocs-no-sitemap-plugin) (👨‍💻 2 · 🔀 1 · 📦 53 · ⏱️ 23.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yamp) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 540 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 380 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 71 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 18 · 🔀 26 · 📥 700 · 📦 3.9K · 📋 100 - 0% open · ⏱️ 15.05.2026)
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 640K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 66K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-embed-external-markdown) (📥 9.2K / month):
	```
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 26 · 📦 97 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 500 / month):
	```
