...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 88K · 📋 2.7K - 0% open · ⏱️ 14.06.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 5 · 🔀 22 · 📥 330 · 📦 85 · 📋 48 - 14% open · ⏱️ 18.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 7.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-blog) (📥 900 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 9.6K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 57 · 📦 6 · ⏱️ 18.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swan) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 74 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 85 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 970K / month):
	```
...
- [PyPi](https://pypi.org/project/mkapi) (📥 8.9K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (👨‍💻 2 · 🔀 2 · 📦 45 · ⏱️ 17.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 31K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 30K / month):
	```
...
- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 2 · 📥 17 · 📦 2 · 📋 15 - 40% open · ⏱️ 07.06.2026)
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 610 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 900 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 59 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 810K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 1.3M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 85K / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 71 · 📦 66 · 📋 34 - 17% open · ⏱️ 22.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 870K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 200K / month):
	```
...
- [GitHub](https://github.com/soulless-viewer/mkdocs-video) (👨‍💻 5 · 🔀 13 · 📥 76 · 📦 1.2K · ⏱️ 04.01.2024)
...
- [PyPi](https://pypi.org/project/markdown-blockdiag) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/lightgallery) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 70K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 3.1K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 92 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 41 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 71 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 99 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-macros-plugin) (📥 2.7M / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 15 · 📦 830 · 📋 68 - 23% open · ⏱️ 10.02.2026)
...
- [GitHub](https://github.com/marimo-team/mkdocs-marimo) (👨‍💻 8 · 🔀 6 · 📦 12 · 📋 27 - 55% open · ⏱️ 15.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 750K / month):
	```
...
- [GitHub](https://github.com/termynal/termynal.py) (👨‍💻 7 · 🔀 12 · 📋 19 - 42% open · ⏱️ 16.03.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 12K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 750 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 3.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 86 / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 43 · 🔀 54 · 📦 13K · ⏱️ 10.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-document-dates) (📥 19K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 540K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 700 / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 2 · 📦 100 · ⏱️ 18.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 9.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 730 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 43 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 12 · 📦 500 · ⏱️ 01.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 80K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 73 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 550K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mdpo-plugin) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 78K / month):
	```
...
- [GitHub](https://github.com/orbikm/mkdocs-ezlinks-plugin) (🔀 13 · 📥 240 · 📦 170 · 📋 27 - 44% open · ⏱️ 24.01.2022)
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 230 / month):
	```
...
- [GitHub](https://github.com/sondregronas/mkdocs-callouts) (👨‍💻 3 · 🔀 4 · 📦 1.4K · ⏱️ 13.06.2026)
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 1.9M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 89K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 35 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 58 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 12 · 🔀 43 · 📦 610 · 📋 120 - 18% open · ⏱️ 10.04.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 6.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 41K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 44 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 700 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 73 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 50K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 32K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 56 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 49K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 170K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 460 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 880 / month):
	```
...
- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 4 · 🔀 16 · 📦 50 · 📋 71 - 56% open · ⏱️ 29.10.2024)
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 960 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 31 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 91 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 700K / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 9 · 📦 63 · ⏱️ 18.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 5.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-new-features-notifier) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 510 / month):
	```
