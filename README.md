...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 90K · 📋 2.7K - 0% open · ⏱️ 06.07.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 5 · 🔀 22 · 📥 350 · 📦 89 · 📋 50 - 12% open · ⏱️ 19.06.2026)
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 74 · 📦 6 · ⏱️ 13.07.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 920 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 400 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 700 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 7.4M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdoxy) (📥 63K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 90 · 📦 280 · 📋 17 - 17% open · ⏱️ 04.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 23K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 74 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 68 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blogging-plugin) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 5.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 82 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 920K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 1.8M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-build-plantuml-plugin) (📥 29K / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 71 · 📦 70 · 📋 34 - 17% open · ⏱️ 22.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 42K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-charts-plugin) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 91 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 97 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 66 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-macros-plugin) (📥 3.3M / month):
	```
...
- [PyPi](https://pypi.org/project/mknotebooks) (📥 40K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-marimo) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-placeholder-plugin) (📥 17K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 960K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 4.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-document-dates) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 1K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 2 · 📦 100 · ⏱️ 16.07.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 55K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 9.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 7.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap-tables-plugin) (📥 710 / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-llmstxt">mkdocs-llmstxt</a></b>  - 🥇21 ·  ⭐ 130 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to generate an /llms.txt file (https://llmstxt.org/).</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 13 · 📦 580 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 380K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 71 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 610K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 85K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 7.3M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 63K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 960K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 24K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-abs-rel-plugin) (📥 4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 29K / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 380 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 54K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 41 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 87 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 81 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 580K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pagetree-plugin) (📥 24K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-include-dir-to-nav) (📥 65K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 96 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 83 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 86K / month):
	```
...
<details><summary><b><a href="https://github.com/koaning/mktestdocs">mktestdocs</a></b>  - 🥈15 ·  ⭐ 160 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code><br>Run pytest against markdown files/docstrings.</summary>

- [GitHub](https://github.com/koaning/mktestdocs) (👨‍💻 6 · 🔀 11 · 📋 8 - 37% open · ⏱️ 10.11.2025)
- [PyPi](https://pypi.org/project/mktestdocs) (📥 65K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 980 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 4.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 570 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 940 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 52 / month):
	```
...
- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 52 · 📥 510 · 📦 6.7K · 📋 200 - 6% open · ⏱️ 14.04.2026)
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 51 · 🔀 79 · 📦 220 · ⏱️ 10.07.2026)
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 790K / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 9 · 📦 63 · ⏱️ 15.07.2026)
- [PyPi](https://pypi.org/project/mkdocs-simple-plugin) (📥 46K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yamp) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 67 / month):
	```
