...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 9K / month):
	```
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 3 · 🔀 20 · 📥 270 · 📦 74 · 📋 39 - 10% open · ⏱️ 23.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 47K / month):
	```
...
<details><summary><b><a href="https://github.com/ntno/mkdocs-terminal">Terminal for MkDocs</a></b>  - 🥇21 ·  ⭐ 320 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>monospace theme for MkDocs.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-simple-blog) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 260 / month):
	```
...
<details><summary><b><a href="https://github.com/wsoft-ws/lantana">Lantana</a></b>  - 🥈11 ·  ⭐ 25 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Lantana MKDocsHTML.</summary>
...
- [PyPi](https://pypi.org/project/lantana):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-swan) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 76 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ivory) (📥 2.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 700 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cluster) (📥 770 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 880K / month):
	```
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 34 · 📦 66 · 📋 73 - 31% open · ⏱️ 29.08.2025)
...
- [PyPi](https://pypi.org/project/mkapi) (📥 14K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typer) (📥 25K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 410 / month):
	```
...
- [GitHub](https://github.com/Kl0ven/mkdocs-material-adr) (👨‍💻 2 · 🔀 2 · 📦 12 · 📋 4 - 50% open · ⏱️ 03.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 97 / month):
	```
...
<details><summary><b><a href="https://github.com/Wesztman/mkdocs-azure-pipelines">mkdocs-azure-pipelines</a></b>  - 🥉6 ·  ⭐ 11 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Generate mkdocs documentation from Azure Pipelines yaml files.</summary>

- [GitHub](https://github.com/Wesztman/mkdocs-azure-pipelines) (👨‍💻 3 · 🔀 1 · 📦 2 · 📋 2 - 50% open · ⏱️ 29.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 110 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 740K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 68K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 92K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 110 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 330 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 70 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-marimo) (📥 13K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 660K / month):
	```
...
- [PyPi](https://pypi.org/project/termynal) (📥 44K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 9.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyterlite) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 75 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 490K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 870 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 54K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 100 · ⏱️ 29.04.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 8.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 39 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 12 · 📦 400 · ⏱️ 01.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 87K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/foliantcontrib.mkdocs) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 93 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 93 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-translations) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 68K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 660K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-backlinks-section-plugin) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 400 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-callouts) (📥 59K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-checklist) (📥 4.6K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 920 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 59 / month):
	```
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 49 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 47 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 930 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 6.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 63 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 47 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-localsearch) (📥 6.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 900 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 860 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 47 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 92 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 690K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-plugin) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 9.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 13K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 69 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 610K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-descriptions-plugin) (📥 25K / month):
	```
