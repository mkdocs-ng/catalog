...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 5 · 🔀 22 · 📥 330 · 📦 87 · 📋 48 - 8% open · ⏱️ 19.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 30K / month):
	```
...
<details><summary><b><a href="https://github.com/ntno/mkdocs-terminal">Terminal for MkDocs</a></b>  - 🥇22 ·  ⭐ 320 · 📈 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>monospace theme for MkDocs.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 8.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-blog) (📥 830 / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 57 · 📦 6 · ⏱️ 24.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 5.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 570 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 730 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 870 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swan) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 2.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 25K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 730 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 84 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 67 / month):
	```
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 3 · 📥 61 · 📦 270 · 📋 17 - 17% open · ⏱️ 04.06.2026)
...
<details><summary><b><a href="https://github.com/syn54x/mkdocs-typer2">mkdocs-typer2</a></b>  - 🥈16 ·  ⭐ 19 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Mkdocs Plugin For Typer CLIs.</summary>

- [GitHub](https://github.com/syn54x/mkdocs-typer2) (👨‍💻 2 · 🔀 2 · 📦 46 · ⏱️ 17.06.2026)
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 14K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typer) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 1.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 66 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 66 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 86 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 850K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 1.7M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 960K / month):
	```
...
- [PyPi](https://pypi.org/project/lightgallery) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 65K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 20K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 350 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 820 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-matplotlib) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 17K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 78 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-macros-plugin) (📥 3.2M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-exec) (📥 980K / month):
	```
...
- [GitHub](https://github.com/marimo-team/mkdocs-marimo) (👨‍💻 8 · 🔀 6 · 📦 13 · 📋 28 - 57% open · ⏱️ 15.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 830K / month):
	```
...
- [PyPi](https://pypi.org/project/termynal) (📥 45K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyterlite) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 3.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 80 / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 43 · 🔀 54 · 📦 13K · 📋 120 - 0% open · ⏱️ 10.06.2026)
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 4 · 🔀 5 · 📦 58 · ⏱️ 19.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 23K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 1.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 820 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 760 / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 2 · 📦 100 · ⏱️ 25.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 9.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 5.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 860 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 53 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 13 · 📦 510 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 330K / month):
	```
...
- [PyPi](https://pypi.org/project/foliantcontrib.mkdocs) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 80 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 570K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 47K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 180K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 54K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 830K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezlinks-plugin) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 20K / month):
	```
...
- [GitHub](https://github.com/realtimeprojects/mkdocs-ezglossary) (👨‍💻 6 · 📋 26 - 11% open · ⏱️ 11.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 7.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-abs-rel-plugin) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 120 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 56 · 🔀 270 · 📦 60K · 📋 430 - 3% open · ⏱️ 23.06.2026)
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 1.8M / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 50K / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 400 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 40 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 96 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 12 · 🔀 43 · 📦 620 · 📋 120 - 18% open · ⏱️ 10.04.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 110K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 7.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 44K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 6.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 51 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 70 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 51K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 5.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 66 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 67 / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 51 · 🔀 79 · 📦 220 · 📋 83 - 1% open · ⏱️ 19.06.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo-plugin) (📥 56K / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 9 · 📦 63 · ⏱️ 25.06.2026)
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 6 · 🔀 6 · 📦 110 · ⏱️ 22.06.2026)
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 49K · ⏱️ 22.06.2026):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 3.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 380 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 580 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 540 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 43 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 50K / month):
	```
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 30 · 📦 99 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 1.2K / month):
	```
