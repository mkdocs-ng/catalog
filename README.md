...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 4K · 📦 85K · 📋 2.7K - 0% open · ⏱️ 23.04.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 9.1K / month):
	```
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 3 · 🔀 20 · 📥 270 · 📦 75 · 📋 39 - 10% open · ⏱️ 23.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 45K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootswatch) (📥 23K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 5 · 🔀 3 · 📥 46 · 📦 6 · ⏱️ 27.04.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 910 / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 470 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 760 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ivory) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 750 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 850 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cluster) (📥 790 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 860K / month):
	```
...
- [PyPi](https://pypi.org/project/neoteroi-mkdocs) (📥 170K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 40K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 37K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 32 · ⏱️ 23.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 8.8K / month):
	```
...
<details><summary><b><a href="https://github.com/watermarkhu/mkdocstrings-matlab">mkdocstrings-matlab</a></b>  - 🥈13 ·  ⭐ 14 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code><br>A MATLAB handler for mkdocstrings, automatic documentation from sources.</summary>

- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 2 · 📥 14 · 📦 2 · 📋 14 - 35% open · ⏱️ 21.04.2026)
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 2.8K / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 98 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/inari) (📥 180 / month):
	```
	pip install inari
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 28 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 29 · 📥 430 · 📋 62 - 22% open · ⏱️ 17.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-rss-plugin) (📥 170K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blogging-plugin) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 260 / month):
	```
...
- [GitHub](https://github.com/blueswen/mkdocs-glightbox) (👨‍💻 9 · 🔀 22 · 📥 44 · 📦 5.9K · 📋 58 - 43% open · ⏱️ 08.03.2026)
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 19 · 🔀 28 · 📦 92 · ⏱️ 13.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 77K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 1.2M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 730K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 67K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 37K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 370 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-blockdiag) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/attakei/oEmbedPy) (👨‍💻 2 · 🔀 1 · 📥 40 · 📦 17 · 📋 8 - 62% open · ⏱️ 27.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-charts-plugin) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 91K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-img2fig-plugin) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 300 / month):
	```
...
- [GitHub](https://github.com/fralau/mkdocs-macros-plugin) (👨‍💻 35 · 🔀 49 · 📦 6.7K · 📋 150 - 2% open · ⏱️ 13.11.2025)
- [PyPi](https://pypi.org/project/mkdocs-macros-plugin) (📥 2.2M / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 15 · 📦 780 · 📋 67 - 22% open · ⏱️ 10.02.2026)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 910K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 640K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 9.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-user-defined-values) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 860 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyterlite) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 110 / month):
	```
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 3 · 🔀 4 · 📦 41 · ⏱️ 23.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-document-dates) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 480K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 55K / month):
	```
...
<details><summary><b><a href="https://github.com/monosans/mkdocs-minify-html-plugin">minify-html</a></b>  - 🥈16 ·  ⭐ 12 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for minification using minify-html, an extremely fast and smart HTML + JS + CSS minifier.</summary>

- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 100 · ⏱️ 30.04.2026)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 8.4K / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-extra-sass-plugin) (🔀 4 · 📦 87 · ⏱️ 13.02.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 140 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 73 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 86K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-render-swagger-plugin) (📥 130K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 1.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 460 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 130 / month):
	```
...
- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 14 · 🔀 47 · 📦 2.3K · 📋 160 - 19% open · ⏱️ 02.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 330K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 80K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 73K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 140K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 640K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 4.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 22K / month):
	```
...
- [GitHub](https://github.com/wilhelmer/mkdocs-unused-files) (👨‍💻 2 · 🔀 5 · 📦 38 · 📋 12 - 33% open · ⏱️ 17.07.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-abs-rel-plugin) (📥 2.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-backlinks-section-plugin) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 170 / month):
	```
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 440K / month):
	```
...
- [GitHub](https://github.com/oprypin/markdown-callouts) (👨‍💻 2 · 🔀 14 · 📦 680 · 📋 13 - 38% open · ⏱️ 17.04.2026)
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-full-yaml-metadata) (📥 2.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 2.5M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 88K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-checklist) (📥 4.5K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpatcher) (📥 400 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 410 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 44K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-djangostaticimage) (📥 60 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 230K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude) (📥 230K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 820 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 310 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-include-dir-to-nav) (📥 69K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 3.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 83 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 5.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-select-files) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 31K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-test) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 31 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-localsearch) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 56K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 940 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pandoc) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 65 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zip-folders) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 130 / month):
	```
...
- [GitHub](https://github.com/jdoiro3/mkdocs-multirepo-plugin) (👨‍💻 17 · 🔀 59 · 📦 240 · 📋 120 - 53% open · ⏱️ 19.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-multirepo-plugin) (📥 70K / month):
	```
...
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 48K · ⏱️ 13.04.2026):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 9.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 530 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yamp) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/octadocs-adr) (📥 100 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 18 · 🔀 26 · 📥 700 · 📦 3.8K · 📋 98 - 1% open · ⏱️ 29.03.2026)
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 620K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 56K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 880 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 640 / month):
	```
